                            ...
                            <div class="col-lg-6 p-md-4 p-3 ">
                                <div class="mt-md-2 mt-0">
                                    ...
                                    <form class="user" method="post" action="<?= base_url('auth/register'); ?>" autocomplete="off">
                                        <?= form_error('nik', '<small class="text-danger mt-3 pl-3 d-block" style="text-align: left;">', '</small>'); ?>
                                        <div class="form-floating mt-2 mb-4">
                                            <input type="text" name="nik" class="form-control" id="nik" placeholder="" value="<?= set_value('nik'); ?>">
                                            <label for="nik">Masukan NIK</label>
                                        </div>
                                        <?= form_error('email', '<small class="text-danger mt-3 pl-3 d-block" style="text-align: left;">', '</small>'); ?>
                                        <div class="form-floating mt-2 mb-4">
                                            <input type="text" name="email" class="form-control" id="email" placeholder="" value="<?php echo set_value('email'); ?>">
                                        ...
                                        <div class="row mt-3 mb-4">
                                            <div class="col">
                                                <input type="text" name="nik" class="form-control" id="nik" placeholder="Masukan Kode" value="<?= set_value('nik'); ?>">
                                            </div>
                                            <div class="col">
                                                <a id="verifyBtn" class="btn btn-sm btn-success mt-1">Kirim Kode</a>
                                            </div>
                                        </div>
