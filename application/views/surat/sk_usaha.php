...
<body class="sb-nav-fixed">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm" role="group">
                                                    <?php $params = "[`$item->no_surat`,`$item->nama_usaha`,`$item->keperluan`,`$item->status_print`,`$item->foto_ktp`,`$item->pas_foto`,`$item->foto_kartu_pajak`,`$item->foto_kartu_vaksin`]"; ?>
    ...
    <script>
        ...
        const setForm = (title, data = null) => {
            modal_title.innerHTML = `${title} Surat Keterangan Usaha`

            const fields = ['no_surat', 'nama_usaha', 'keperluan', 'status_print', 'foto_ktp', 'pas_foto', 'foto_kartu_pajak', 'foto_kartu_vaksin'];
            fields.forEach((e, i) => {
