                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm" role="group">
                                                    <?php $params = "[`$item->no_surat`,`$item->keperluan`,`$item->status_print`,`$item->foto_ktp`,`$item->pas_foto`,`$item->foto_kartu_pajak`,`$item->foto_kartu_vaksin`]"; ?>
                                                    ...
                                                    <?php $data['jenis_surat'] = 'sk_domisili'; ?>
